...
public class BoardManager : MonoBehaviour
{
    ...
    private void InitializeBoardArray()
    {
        ...
        m_currentBoard = m_boardArray[startingBoard, startingBoard];

        m_cameraOffset = Camera.main.transform.position - m_currentBoard.centerPos;

        Camera.main.transform.position = new Vector3(m_boardArray[startingBoard, startingBoard].centerPos.x,
            m_boardArray[startingBoard, startingBoard].centerPos.y + m_cameraOffset.y,
            m_boardArray[startingBoard, startingBoard].centerPos.z + m_cameraOffset.z);
    }
